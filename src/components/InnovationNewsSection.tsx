...
import { innovationVideos, newsItems } from '../config/news';
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {newsItems.map((item, index) => (
              <motion.div
                ...
                className="group flex flex-col h-full bg-white rounded-[24px] overflow-hidden border border-slate-100/60 hover:border-slate-200 hover:shadow-xl transition-all duration-500 cursor-pointer"
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-50">
                  ...
                  <div className="absolute top-3 left-3">
                    <Typography variant="caption" className={`px-2 py-0.5 bg-white/90 backdrop-blur-md rounded-full font-black tracking-widest text-[8px] shadow-sm ${item.colorClass}`}>
                      {t(item.categoryKey)}
                    </Typography>
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-50">
                    ...
                    <div className="flex items-center gap-1 text-slate-300">
                      <Calendar size={12} />
                      <Typography className="text-[10px] font-medium">2024</Typography>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          <div className="text-center">
            ...
            >
              <Button
                variant="outlined"
                href="/news" // Assuming a news page exists or will be created
                size="large"
