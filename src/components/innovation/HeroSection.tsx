...
export default function HeroSection() {
  ...
  const stats = [
    ...
    { title: '84nm', desc: 'Nano Particle Size' },
    { title: '99.9%', desc: 'Antimicrobial Rate' },
  ];

  const pills = [
    { icon: Binary,      label: 'Nano-Tech Certified' },
    { icon: ShieldCheck, label: 'FDA USA Approved' },
    { icon: Globe,       label: 'EFSA EU Approved' },
  ];

  return (
    <section className="relative min-h-[92vh] flex flex-col justify-between bg-white overflow-hidden">

      {/* ─── Large editorial background watermark ─── */}
